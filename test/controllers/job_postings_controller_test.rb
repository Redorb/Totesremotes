...
class JobPostingsControllerTest < ActionController::TestCase
  ...
  test "should create job_posting" do
    assert_difference('JobPosting.count') do
      post :create, job_posting: { company: @job_posting.company, description: @job_posting.description, job: @job_posting.job, location: @job_posting.location, salary: @job_posting.salary, tags: @job_posting.tags }
    end
  ...
  test "should update job_posting" do
    patch :update, id: @job_posting, job_posting: { company: @job_posting.company, description: @job_posting.description, job: @job_posting.job, location: @job_posting.location, salary: @job_posting.salary, tags: @job_posting.tags }
    assert_redirected_to job_posting_path(assigns(:job_posting))
  end
